	...
	__( 'WPForms', 'wsal-wpforms' ) => array(
		__( 'Form Content', 'wsal-wpforms' ) => array(
			...
			array(
				...
				__( 'Form name: %PostTitle% %LineBreak% Form ID: %PostID% %LineBreak% %EditorLinkForm%', 'wsal-wpforms' ),
				'wpforms_forms',
				'created',
			),
			...
			array(
				...
				__( 'Source form: %OldPostTitle% %LineBreak% New form name: %PostTitle% %LineBreak% Source form ID: %SourceID% %LineBreak% New form ID: %PostID% %LineBreak% %EditorLinkFormDuplicated%', 'wsal-wpforms' ),
				'wpforms_forms',
				'duplicated',
			),
			...
			array(
				...
				__( 'All the notifications in the form %form_name% %LineBreak% Form ID: %PostID% %LineBreak% %EditorLinkForm%', 'wsal-wpforms' ),
				'wpforms_notifications',
				'deleted',
			),
			...
			array(
				...
				__( 'Previous form name: %old_form_name% %LineBreak% New form name: %new_form_name% %LineBreak% Form ID: %PostID% %LineBreak% %EditorLinkForm%', 'wsal-wpforms' ),
				'wpforms_forms',
				'renamed',
			),
			...
			array(
				...
				__( 'Entry ID: %entry_id% %LineBreak% From form: %form_name% %LineBreak% Modified field name: %field_name% %LineBreak% Previous value: %old_value% %LineBreak% New Value: %new_value% %LineBreak% %EditorLinkEntry%', 'wsal-wpforms' ),
				'wpforms_entries',
				'modified',
			),
			...
			array(
				...
				__( 'Access setting: %setting_name% %LineBreak% Type: %setting_type% %LineBreak% Previous privileges: %old_value% %LineBreak% New privileges: %new_value%', 'wsal-wpforms' ),
				'wpforms',
				'modified',
			),
			...
			array(
				...
				__( 'Changed the <strong>currency</strong> %LineBreak% Previous currency: %old_value% %LineBreak% New currency: %new_value%', 'wsal-wpforms' ),
				'wpforms',
				'modified',
			),
			...
			array(
				...
				__( 'A service integration with %service_name% %LineBreak% Connection name: %connection_name%', 'wsal-wpforms' ),
				'wpforms',
				'added',
			),
