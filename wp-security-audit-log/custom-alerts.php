	...
	__( 'WPForms', 'wp-security-audit-log' ) => array(
		__( 'Form Content', 'wp-security-audit-log' ) => array(
			...
			array(
				...
				__( 'Notification name %notifiation_name% %LineBreak% Form name %form_name% %LineBreak% Form ID %PostID% %LineBreak% %EditorLinkPost%', 'wp-security-audit-log' ),
			...
			array(
				...
				__( 'All the notifications in the form. %LineBreak% Form name %form_name% %LineBreak% ID %PostID% %LineBreak% %EditorLinkPost%', 'wp-security-audit-log' ),
				'wpforms_notifications',
				'deleted',
			),
		),
