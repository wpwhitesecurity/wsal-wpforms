...
Keep a record of all the changes that happen on WPForms in an activity log.

== Description ==

Install this add-on and the WP Security Audit Log plugin to keep a record of the changes that happen on your WPForms plugin, such as when someone creates a form, modified a form, deletes an entry and much more!
